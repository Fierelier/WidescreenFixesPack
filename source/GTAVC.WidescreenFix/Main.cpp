...
{
    return shAvoidTheGeometry.unsafe_fastcall(camera, edx, Source, TargetPos, NewSource, CDrawFix::ConvertFOVInverse(FOV));
}
...
public:
    Main()
    {
        ...
        WFP::onGameInitEvent() += []()
        {
            ...
            {
                *(float*)(regs.ebp + 0xB4) = CDrawFix::ConvertFOVInverse(70.0f);
            });
