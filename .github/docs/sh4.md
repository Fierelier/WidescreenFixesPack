![sh4](https://thirteenag.github.io/screens/sh4/main2.jpg)
...
$${\color{blue}ⓘ}$$ Added an option to increase pause background resolution

$${\color{blue}ⓘ}$$ Added an option to fix cutscene framerate

$${\color{blue}ⓘ}$$ Added an option to disable registry dependency
...
[Website](https://thirteenag.github.io/wfp#sh4) | [Source](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/source/SilentHill4.WidescreenFix/dllmain.cpp) | [Default INI File](https://github.com/ThirteenAG/WidescreenFixesPack/blob/master/data/SilentHill4.WidescreenFix/scripts/SilentHill4.WidescreenFix.ini)
